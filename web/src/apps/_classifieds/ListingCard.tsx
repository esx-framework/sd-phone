        ...
        >
            <div className="block w-full text-start">
                <div className="flex items-start justify-between gap-3">
                    <h3 dir="auto" className="min-w-0 truncate text-[21px] font-semibold text-black dark:text-white">{item.title}</h3>
                ...
                <div className="mt-1.5 flex gap-3.5">
                    <div className="flex min-w-0 flex-1 flex-col">
                        <p dir="auto" className="line-clamp-3 text-[18px] leading-snug text-black dark:text-white">{item.body}</p>
                    ...
                    {(() => {
                        ...
                        return (
                            <div className="relative h-[112px] w-[112px] shrink-0">
                                ...
                                />
                                {photos.length > 1 && (
                                    <span className="absolute bottom-1.5 end-1.5 rounded-full bg-black/60 px-1.5 py-0.5 text-[12px] font-semibold text-white">
                                        +{photos.length - 1}
                                    </span>
                                )}
                            </div>
